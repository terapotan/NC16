...
# reg-[memaddr+opd]
xxx100000000aaaa1001 010011aaa000aaaa010 # add r1, [memaddr+opd]
xxx100000001aaaa1001 010011aaa001aaaa010 # sub r1, [memaddr+opd]
...
# mov r1, [memaddr+opd]
xxx100001000aaaa1001 010010000000aaaa010 # mov r1, [memaddr+opd]
# mov memval, [memaddr+opd]
xxx10000100010111001 0100100000001010010 # mov memval, [memaddr+opd]
# mov memaddr,r1
xxx1000010001010aaaa 0aaaa00000001001000 # mov memaddr,r1
# mov memval,r1
...
xxx10000101011111111 0011100000001000000 # out opd
...
# jmp,jcc命令
xxx10001000110111111 0101100000000111000 # jmp memval

0xx100001011aaaa1111 0aaaa00000000111000 # jnc r1 (Taken)
1xx100001011aaaa1111 0000000000001111000 # jnc r1 (Skip)
1xx100001100aaaa1111 0aaaa00000000111000 # jc r1 (Taken)
0xx100001100aaaa1111 0000000000001111000 # jc r1 (Skip)
...
fixed_lines = [
    ...
    "0xx10000101111111111 0011100000000111000 # jnc opd (Taken)",
    "1xx10000101111111111 0000000000001111000 # jnc opd (Skip)",
    "1xx10000110011111111 0011100000000111000 # jc opd (Taken)",
    "0xx10000110011111111 0000000000001111000 # jc opd (Skip)",
    ...
    "xxx10001010111111111 0101000000001010000 # lpc",
]
