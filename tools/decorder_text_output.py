...
# mov r1, [a]
xx100001000aaaa0111 010010000000aaaa010 # mov r1, [a]

# mov r1, opd
xx100001000aaaa1111 001110000000aaaa000 # mov r1, opd

# mov r1, [opd]
xx100001000aaaa0111 010010000000aaaa100 # mov r1, [opd]
...
# jmp,jcc命令
0x100001101aaaa1111 0aaaa00000000111000 # jnz r1 (Taken)
1x100001101aaaa1111 0000000000001111000 # jnz r1 (Skip)
1x100001110aaaa1111 0aaaa00000000111000 # jz r1 (Taken)
0x100001110aaaa1111 0000000000001111000 # jz r1 (Skip)
x0100001111aaaa1111 0aaaa00000000111000 # jns r1 (Taken)
x1100001111aaaa1111 0000000000001111000 # jns r1 (Skip)
x1100010000aaaa1111 0aaaa00000000111000 # js r1 (Taken)
x0100010000aaaa1111 0000000000001111000 # js r1 (Skip)
xx100010001aaaa1111 0aaaa00000000111000 # jmp r1
1x100010110aaaa1111 0aaaa00000000111000 # je r1 (Taken)
0x100010110aaaa1111 0000000000001111000 # je r1 (Skip)
0x100010111aaaa1111 0aaaa00000000111000 # jne r1(Taken)
1x100010111aaaa1111 0000000000001111000 # jne r1(Skip)
00100011000aaaa1111 0aaaa00000000111000 # ja r1 (Taken)
xx100011000aaaa1111 0000000000001111000 # ja r1 (Skip)
00100011001aaaa1111 0aaaa00000000111000 # jae r1 (Taken)
10100011001aaaa1111 0aaaa00000000111000 # jae r1 (Taken)
xx100011001aaaa1111 0000000000001111000 # jae r1 (Skip)
01100011010aaaa1111 0aaaa00000000111000 # jl r1 (Taken)
xx100011010aaaa1111 0000000000001111000 # jl r1 (Skip)
01100011011aaaa1111 0aaaa00000000111000 # jle r1 (Taken)
10100011011aaaa1111 0aaaa00000000111000 # jle r1 (Taken) 
xx100011011aaaa1111 0000000000001111000 # jle r1 (Skip)
"""
...
fixed_lines = [
    ...
    "1x10001011011111111 0011100000000111000 # je opd (Taken)",
    "0x10001011011111111 0000000000001111000 # je opd (Skip)",
    "0x10001011111111111 0011100000000111000 # jne opd(Taken)",
    "1x10001011111111111 0000000000001111000 # jne opd(Skip)",
    "0010001100011111111 0011100000000111000 # ja opd (Taken)",
    "xx10001100011111111 0000000000001111000 # ja opd (Skip)",
    "0010001100111111111 0011100000000111000 # jae opd (Taken)",
    "1010001100111111111 0011100000000111000 # jae opd (Taken)",
    "xx10001100111111111 0000000000001111000 # jae opd (Skip)",
    "0110001101011111111 0011100000000111000 # jl opd (Taken)",
    "xx10001101011111111 0000000000001111000 # jl opd (Skip)",
    "0110001101111111111 0011100000000111000 # jle opd (Taken)",
    "1010001101111111111 0011100000000111000 # jle opd (Taken)", 
    "xx10001101111111111 0000000000001111000 # jle opd (Skip)",  
    ...
    "xxx1111111111111111 0000000000001111000 # invaild",
    "xx10001010111111111 0101000000000000000 # lpc",
]
