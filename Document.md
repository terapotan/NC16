...
## 条件付きジャンプ命令
　ゼロフラグ、符号フラグの値によって指定のアドレスにジャンプするかが決まる命令群です。
...
## LPC
　lpc命令の一つ前の命令を実行するときのプログラムカウンタの値をAレジスタに転送します。
|ニーモック|ファンクションコード|FuncInput1|FuncInput2|オペランド|動作
|:--:|:--:|:--:|:--:|:--:|:--:|
|lpc|0x15|0xf|0xf|0x0000|lpc命令の一つ前の命令を実行するときのプログラムカウンタの値をAレジスタに転送します|
## 無効命令
