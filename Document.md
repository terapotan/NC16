...
|bit32|bit31|bit30|bit29|bit32|bit31|bit30|bit29|対応する命令|
|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
|0|0|0|0|0|0|0|0|add|
|0|0|0|0|0|0|0|1|sub|
|0|0|0|0|0|0|1|0|mul|
...
## 凡例
1. opd:オペランドを表します。
2. r:A,B,C,D,E,F,SP,BPレジスタのいずれか一つを表します。r1,r2のように添え字をつけて区別することがあります。
...
|ニーモック|FuncInput1|FuncInput2|オペランド|動作
|:--:|:--:|:--:|:--:|:--:|
|sub r1,r2|r1|r2|0x0000|r1レジスタの値にr2レジスタの値を減算し、その値をr1レジスタに格納します
|sub r1,opd|r1|0xf|opd|r1レジスタの値にオペランドを減算し、その値をr1レジスタに格納します
|sub r1,[a]|r1|メモリ|0x0000|r1レジスタの値に[Aレジスタの値]番地の値を減算し、その値をr1レジスタに格納します
### mul
