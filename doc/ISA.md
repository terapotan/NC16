...
|ニーモニック|ファンクションコード|FuncInput1|FuncInput2|オペランド|動作
|:--:|:--:|:--:|:--:|:--:|:--:|
|syscall|0x28|0xf|0xf|0x0000|実行モードをカーネルモードにし、割り込み番号511番の割り込みを発生させます
## usercall
　実行モードをユーザーモードにし、指定した番地にcallします。OS側からユーザープログラムを呼び出す際に使用します。
|ニーモニック|ファンクションコード|FuncInput1|FuncInput2|オペランド|動作
|:--:|:--:|:--:|:--:|:--:|:--:|
|usercall opd|0x29|0xf|0xf|opd|実行モードをユーザーモードにし、指定した番地にcallします
## userret
　ユーザープログラムからOS側に処理を戻すとともに、実行モードをユーザーモードからカーネルモードに戻します。usercallと対になるように使用します。
|ニーモニック|ファンクションコード|FuncInput1|FuncInput2|オペランド|動作
|:--:|:--:|:--:|:--:|:--:|:--:|
|userret|0x2a|0xf|0xf|0x0000|ユーザープログラムからOS側に処理を戻すとともに、実行モードをユーザーモードからカーネルモードに戻します
